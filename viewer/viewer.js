...
PDFJS.imageResourcesPath = './images/';
  PDFJS.workerSrc = '../includes/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = '../includes/pdfjs/web/cmaps/';
...
var SecondaryToolbar = {
  ...
  lastPageClick: function secondaryToolbarLastPageClick(evt) {
    if (PDFView.pdfDocument) {
      ...
      ws.send(pdfid+":"+PDFView.pdfDocument.numPages.toString());
    }
    this.close();
  },
  ...
  mouseDown: function presentationModeMouseDown(evt) {
    ...
    if (evt.button === 0) {
      ...
      if (!isInternalLink) {
        ...
        ws.send(pdfid+":"+PDFView.page.toString());
      }
    }
  },
...
function webViewerInitialized(fileid) {
  var params = PDFView.parseQueryString(document.location.search.substring(1));
  pdfid = fileid;
  var file = "uploads/"+fileid+".pdf";
